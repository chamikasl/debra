...
// Check if 'login_id' is set in the session
if (isset($_SESSION['login_id'])) {
	$login_id = $_SESSION['login_id'];

	if (isset($_GET['id'])) {
		$mov = $conn->query("SELECT * FROM events WHERE id = " . $_GET['id']);
	...
	<div class="col-lg-12">
		<form id="manage-movie">
			<div class="form-group">
				...
				<input type="hidden" name="partner_id" value="<?php echo isset($_SESSION['login_id']) ? $_SESSION['login_id'] : '' ?>">
				<label for="" class="control-label">Title:</label>
				<input type="text" name="title" required="" class="form-control" value="<?php echo isset($meta['title']) ? $meta['title'] : '' ?>">
			</div>
			<div class="form-group">
				<label for="" class="control-label">Location:</label>
				<input type="text" name="location" required="" class="form-control" value="<?php echo isset($meta['location']) ? $meta['location'] : '' ?>">
			</div>
			<div class="form-group">
				<label for="" class="control-label">Ticket Price:</label>
			...
			<div class="form-group row">
				<label for="" class="control-label col-md-12">Time:</label>
				<input type="number" name="duration_hour" required="" class="form-control col-sm-3 offset-md-1 " value="<?php echo isset($meta['duration_hour']) ? $meta['duration_hour'] : '' ?>" max="12" min="0" placeholder="Hour">:
				<input type="number" name="duration_min" required="" class="form-control col-sm-3 " max="59" min="0" value="<?php echo isset($meta['duration_min']) ? $meta['duration_min'] : '' ?>" placeholder="Min">
			</div>
			<div class="form-group">
